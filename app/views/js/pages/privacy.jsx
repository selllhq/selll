            ...
            <div className="pb-20 pt-40 bg-white dark:bg-[#141414]">
                <div className="container mx-auto max-w-4xl px-6">
                    ...
                    <div className="space-y-8 text-gray-700 dark:text-gray-300">
                        <section>
                            <p className="mb-6">
                                At Selll, we take your privacy seriously. This
                                Privacy Policy explains how we collect, use,
                                disclose, and safeguard your information when
                                you use our platform. Please read this policy
                                carefully. By using Selll, you consent to the
                        ...
                        <section>
                            ...
                            <ul className="list-disc pl-6 space-y-2">
                                ...
                                <li>
                                    Store information (such as store name,
                                    description, and customization settings)
                                </li>
                                <li>
                                    Transaction data (such as products
                                    purchased, sales history, and customer
                                    information)
                                </li>
                                <li>
                                    Usage data (such as how you interact with
                                    our platform, IP address, browser type, and
                                    device information)
                                </li>
                                <li>
                                    Communication (such as delivery updates to
                                    customers, support tickets, direct messages
                                    to us, and feedback)
                                </li>
                                <li>
                                    Customer data (such as name, location, order
                                    history, interactions with stores and
                                    products)
                                </li>
                            </ul>
                        </section>
                        ...
                        <section>
                            ...
                            <ul className="list-disc pl-6 space-y-2">
                                ...
                                <li>
                                    ...
                                    activities in connection with our platform
                                </li>
                                <li>
                        ...
                        <section>
                            ...
                            <ul className="list-disc pl-6 space-y-2">
                                ...
                                <li>
                                    Stores who require information for
                                    processing orders
                                </li>
                                <li>
                                ...
                                <li>
                                    Business partners with whom we jointly offer
                                    products or services
                                </li>
                                <li>
                                    Business acquisition, mergers or bankruptcy
                                    proceedings
                                </li>
                                <li>
                                    Law enforcement or other governmental
                                    officials, in response to a verified request
                                </li>
                            </ul>
                            <p className="mt-3">
                        ...
                        <section>
                            ...
                            <p className="mb-3">
                                ...
                                to track activity on our platform and hold
                        ...
                        <section>
                            ...
                            <p className="mb-3">
                                ...
                                13 years of age (or 16 in the EU). We do not
                                knowingly collect personal information from
                                children. If you are a parent or guardian and
                                believe your child has provided us with personal
                                information, please contact us for immediate
                                deletion.
                            </p>
                        </section>
