...
const Setup = ({ auth }) => {
    ...
    return (
        <>
            ...
            <div className="w-full dark:bg-[#141414] flex flex-col md:flex-row">
                <div className="max-h-screen w-full lg:w-[60%] overflow-y-auto dark:border-r border-[#2C2C2C]">
                    <div className="max-w-xl w-full mx-auto px-4 md:px-8 md:pt-40 py-10 relative">
                        <div className="mb-10 md:pt-12">
                            <h2 className="text-3xl md:text-4xl font-bold mb-2">
                                Welcome {auth.user.name?.split(" ")[0]}!
                            </h2>
                            <p className="text-muted-foreground dark:text-gray-400">
                                You're just 2 minutes away from <br /> selling
                                your first product.
                            </p>
                        </div>
                        ...
                        <form onSubmit={submit} className="space-y-8 pb-8">
                            ...
                            <div className="mb-6">
                                ...
                                {errors?.description ? (
                                    ...
                                    <small className="text-xs text-muted-foreground mt-1 block">
                                        This will show when the users click on
                                        the 'About' tab on your store.
                                    </small>
                                )}
                            </div>
                            ...
                            <div className="mt-6">
                                ...
                                <InputError
                                    message={errors.selling_journey_status}
                                    className="mt-2"
                                />
                            </div>
                            ...
                            <div className="mt-6">
                                ...
                                <Input
                                    ...
                                    onChange={(e) =>
                                        setData("product_types", e.target.value)
                                    }
                                >
                            ...
                            <div className="mt-6">
                                ...
                                <InputError
                                    message={errors.estimated_sales_volume}
                                    className="mt-2"
                                />
                            </div>
                            ...
                            <div className="mt-6">
                                <Label
                                    ...
                                    className="text-sm font-medium block mb-3"
                                >
                                    Where do you most of your customers come
                                    from?
