...
export default function Payouts({ auth, payouts = [], orders = [], currentStore }) {
    ...
    return (
        ...
        >
                ...
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-gray-400">
                            Manage your store's payouts and withdraw your earnings
                        </p>
                    </div>
                    ...
                    <Card>
                        ...
                        <CardContent>
                            <div>
                                ...
                                <div className="flex items-center gap-1 text-gray-400">
                                    <span className="text-sm">
                                        From {payouts.filter(p => p.status === "completed").length} completed payouts
                                    </span>
                                </div>
                            </div>
                        </CardContent>
                    ...
                    <Card>
                        ...
                        <CardContent>
                            <div>
                                ...
                                <div className="flex items-center gap-1 text-gray-400">
                                    <span className="text-sm">
                                        From {pendingPayouts.length} pending payouts
                                    </span>
                                </div>
                            </div>
                        </CardContent>
                                        ...
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-xs text-gray-400">
                                                    Requested on {dayjs(payout.created_at).format("MMM D, YYYY")}
                                                </p>
                                            </div>
                                        </div>
                                    ...
                                    <div className="flex items-center justify-between mt-4">
                                        <div className="flex items-center gap-1">
                                            <div className="flex items-center gap-1">
                                                ...
                                                <span className="text-xs text-white">Processed</span>
                                            </div>
                                            <div className="bg-[#2C2C2C] rounded-md px-2 py-0.5 text-xs font-medium text-white">
                                                {payout.processed_at 
                                                    ? dayjs(payout.processed_at).format("MMM D, YYYY") 
                                                    : "Pending"}
                                            </div>
                                        </div>
                                        
                                        <div className={`flex items-center gap-2 px-2 py-1 rounded-full ${getStatusColor(payout.status)}`}>
            ...
            <Dialog.Root open={showRequestDialog} onOpenChange={setShowRequestDialog}>
                <Dialog.Portal>
                        ...
                        <form onSubmit={handleSubmit}>
                                    ...
                                    <>
                                        <div>
                                            ...
                                            <Input
                                                ...
                                                required
                                            />
                                            {errors.account_name && <InputError message={errors.account_name} />}
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <Input
                                                ...
                                                required
                                            />
                                            {errors.bank_name && <InputError message={errors.bank_name} />}
                                        </div>
                                    </>
                                )}
                            ...
                            <div className="flex items-center justify-end gap-3 mt-6">
                                ...
                                <Button
                                    type="submit"
                                    className="bg-primary-orange hover:bg-primary-orange/90"
                                    disabled={processing || data.amount <= 0 || data.amount > availableBalance}
                                >
