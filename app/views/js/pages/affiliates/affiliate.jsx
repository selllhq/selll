...
const Affiliates = ({ affiliate }) => {
    const affiliateLink = `https://${affiliate.product.store.slug}.selll.store/products/${affiliate.slug}`;
                    ...
                    <Card className="p-0 rounded-3xl !bg-background !ring-0">
                        ...
                        <h3 className="text-lg font-semibold text-gray-800 dark:text-white mb-2">
                            ...
                            {new Intl.NumberFormat("en-US", {
                                style: "currency",
                                currency: "GHS",
                            }).format(affiliate.product.price)}{" "}
                            +{" "}
                        ...
                        <p>
                            by{" "}
                            <a
                                href={`https://${affiliate.product.store.slug}.selll.store`}
                                className="underline"
                                target="_blank"
                                rel="noopener noreferrer"
                            >
                                {affiliate.product.store.name}
                            </a>
                        </p>
                        ...
                        <div className="mt-6">
                            ...
                            <div className="flex items-center space-x-2">
                                <Input
                                    ...
                                    value={affiliateLink}
                                    readOnly
                                    className="flex-1 dark:bg-[#141414] dark:border-[#333]"
                                />
                                <Button
                                    onClick={() => {
