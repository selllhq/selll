                ...
                <div className="container mx-auto max-w-4xl px-6">
                    ...
                    <div className="space-y-8 text-gray-700 dark:text-gray-300">
                        ...
                        <section>
                            ...
                            <p className="mb-3">
                                If you have any questions about these Terms, please contact us at <a href="mailto:support@selll.online" className="text-primary-orange hover:underline">support@selll.online</a> or visit our <Link href="/contact" className="text-primary-orange hover:underline">contact page</Link>.
                            </p>
                        </section>
                    </div>
