...
class BlogController extends Controller
{
    ...
    private function getSamplePosts()
    {
        return [
            [
                'title' => '🎉🎉 Introducing Selll Links - The Easiest Way to Get Paid',
                'slug' => 'selll-links',
