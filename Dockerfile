...
RUN apt-get update && apt-get install -y --no-install-recommends \
    ...
    php${PHP_VERSION}-opcache php${PHP_VERSION}-xml php${PHP_VERSION}-fileinfo \
    php${PHP_VERSION}-tokenizer php${PHP_VERSION}-ctype php${PHP_VERSION}-curl \
    php${PHP_VERSION}-dom php${PHP_VERSION}-gd php${PHP_VERSION}-mysql \
    php${PHP_VERSION}-pgsql php${PHP_VERSION}-sqlite3 php${PHP_VERSION}-simplexml \
    php${PHP_VERSION}-xmlwriter php${PHP_VERSION}-session php${PHP_VERSION}-bcmath \
    php${PHP_VERSION}-exif php${PHP_VERSION}-iconv php${PHP_VERSION}-json \
    php${PHP_VERSION}-phar php${PHP_VERSION}-posix php${PHP_VERSION}-zip php${PHP_VERSION}-zlib \
